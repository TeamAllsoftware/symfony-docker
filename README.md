...
- `docker login`
- `docker build -t [IMAGE:nouveau_tag] .`, ex : `docker build -t allsoftware/symfony:7-php-8.5-v4 .`
- `docker push [IMAGE:nouveau_tag]`, ex : `docker push allsoftware/symfony:7-php-8.5-v4`
